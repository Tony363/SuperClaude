...
def run(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        print("    Security: Symlinks outside user directory are not allowed.")
        sys.exit(1)
    except Exception as e:
        print(f"\n[✗] Security validation failed: {e}")
        print("    Please use a standard directory path within your user profile.")
        sys.exit(1)
        ...
        if success:
            if not args.quiet:
                ...
                if not args.dry_run:
                    ...
                    print("3. Use SuperClaude commands and features in Claude Code")
