...
- Extended personas execute via generated Python wrappers, yet only the 15 core strategists ship
  with deeper heuristics—complex domains may still need follow-up after the autogenerated pass.
...
have been retired and no longer ship with the framework. **Rube** now ships enabled by default and
