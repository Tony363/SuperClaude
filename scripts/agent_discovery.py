...
def main():
    ...
    parser.add_argument('--suggest', action='store_true', help='Suggest agents for current context')
    parser.add_argument('--list-all', action='store_true', help='List all available agents')
    parser.add_argument('--list-core', action='store_true', help='List core agents only')
    parser.add_argument('--list-extended', action='store_true', help='List extended agents only')
    ...
    if args.search:
        ...
        for agent in sorted(discovery.agents, key=lambda x: (x.get('priority', 99), x['id'])):
        ...
        for agent in sorted(extended_agents, key=lambda x: (x.get('priority', 99), x['id'])):
            print(f"  • {agent['id']}: {agent.get('description', 'N/A')}")
