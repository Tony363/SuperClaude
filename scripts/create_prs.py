...
def main():
    parser = argparse.ArgumentParser(
        description="Create or update nightly review PRs"
    )
    parser.add_argument(
        "--pr-content-dir",
        type=Path,
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="Maximum PRs per run"
    )
    parser.add_argument(
        "--stale-days",
        type=int,
        default=7,
        help="Days before PR is considered stale"
    )
