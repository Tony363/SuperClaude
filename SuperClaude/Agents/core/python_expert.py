...
class PythonExpert(BaseAgent):
    ...
    def execute(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            result['actions_taken'].append(f"Analyzed {analysis.get('complexity', 'N/A')} complexity")
            ...
            result['actions_taken'].append(f"Generated {len(improvements)} improvements")
            ...
            report = self._generate_python_report(
                task, analysis, patterns, improvements,
            ...
            if 'improve' in task.lower() or 'refactor' in task.lower():
                improved_code = self._generate_improved_code(code, improvements, patterns)
    ...
    def validate(self, context: Dict[str, Any]) -> bool:
        ...
        python_keywords = [
            ...
            'pytest', 'pandas', 'numpy', 'async', 'decorator',
            'generator', 'comprehension', 'pythonic'
        ]
        ...
        return has_python_files or any(keyword in task_lower for keyword in python_keywords)
    ...
    def _initialize_design_patterns(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            'strategy': {
                ...
                'use_cases': ['Payment processing', 'Sorting algorithms', 'Export formats'],
    ...
    def _initialize_code_standards(self) -> Dict[str, Any]:
        ...
        return {
            'pep8': {
                ...
                'rules': ['4 spaces indentation', '79 char line limit', 'Snake_case naming']
            },
            'pep257': {
                'name': 'PEP 257',
            ...
            'type_hints': {
                ...
                'rules': ['Function annotations', 'Variable annotations', 'Generic types']
            },
            'solid': {
                'name': 'SOLID Principles',
                'description': 'OOP design principles',
                'rules': ['Single responsibility', 'Open/closed', 'Dependency inversion']
            }
        }
    ...
    def _analyze_code_quality(self, code: str, files: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            if any(hasattr(node, 'decorator_list') and node.decorator_list
    ...
    def _generate_recommendations(
        ...
        improvements: List[Dict[str, Any]], test_coverage: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
        """
    ...
    def _generate_improved_code(
        self, original_code: str, improvements: List[Dict[str, Any]],
    ...
    def _generate_python_report(
        ...
        patterns: List[Dict[str, Any]], improvements: List[Dict[str, Any]],
        test_coverage: Dict[str, Any], recommendations: List[Dict[str, Any]]
    ) -> str:
        """
        ...
        if analysis.get('metrics'):
            ...
            lines.append(f"**Async Functions**: {analysis['metrics'].get('async_functions', 0)}")
        ...
        if patterns:
            ...
            for pattern in patterns:
                ...
                lines.append(f"### {pattern_info.get('name', pattern['pattern'].title())}")
        ...
        if improvements:
            ...
            sorted_imps = sorted(improvements, key=lambda x: priority_order.get(x['priority'], 3))

            for imp in sorted_imps:
                priority_emoji = {'high': '🔴', 'medium': '🟡', 'low': '🟢'}.get(imp['priority'], '⚪')
                lines.append(f"{priority_emoji} **{imp['category']}**: {imp['improvement']}")
