...
This project is indexed by GitNexus as **SuperClaude** (6388 symbols, 16783 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
