...
**--dw / --deepwiki**
- Trigger: Library imports, framework questions, technical documentation needs
- Behavior: Enable Deepwiki for comprehensive documentation retrieval and code examples
...
**--test**
- Trigger: After code changes, before marking tasks complete
- Behavior: Run test suites, validate changes, ensure quality

**--review**
- Trigger: Before commits, code quality checks
- Behavior: Code review mode with quality analysis and suggestions

**--fix**
- Trigger: Linting errors, formatting issues
- Behavior: Auto-fix linting and formatting issues where possible
...
- Behavior: Deep analysis (~10K tokens), enables Sequential + Deepwiki
...
**--no-exceptions**
- Trigger: Error handling implementation, defensive coding scenarios
- Behavior: Enforce validation-first approach, minimize try/catch usage, prefer explicit error handling

## Execution Control Flags

**--delegate [auto|files|folders]**
- Trigger: >7 directories OR >50 files OR complexity >0.8
- Complexity Formula: `(files × directories × dependencies) / 100`
...
- Example: `--concurrency 5` limits to 5 parallel operations
...
- Risk Score Formula: `(impact × probability × irreversibility) / 10`
...
**--delegate-search**
- Trigger: Search operations with unknown scope, exploration needs
- Behavior: Auto-delegate to general-purpose Task agent for comprehensive search

**--delegate-debug**
- Trigger: Error investigation, debugging scenarios, root cause analysis
- Behavior: Auto-delegate to root-cause-analyst for systematic investigation

**--delegate-refactor**
- Trigger: Code improvement requests, technical debt reduction
- Behavior: Auto-delegate to refactoring-expert for systematic improvements

**--delegate-docs**
- Trigger: Documentation generation across multiple files
- Behavior: Auto-delegate to technical-writer for comprehensive documentation

**--delegate-test**
- Trigger: Test coverage analysis, quality assessment needs
- Behavior: Auto-delegate to quality-engineer for testing improvements
