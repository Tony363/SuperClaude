...
use crate::proto::super_claude_service_server::SuperClaudeServiceServer;
...
async fn main() -> Result<()> {
    ...
    // Create the service
    let service = Arc::new(SuperClaudeService::new());
    let grpc_service = SuperClaudeServiceServer::new(service.clone());
